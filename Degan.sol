...
contract DegenToken is ERC20,Ownable,ERC20Burnable{
    ...
    function redeemCards( Cards _card)public{
        if(_card == Cards.rare){
            require(balanceOf(msg.sender)>=15,"Low degen");
            ...
            require(balanceOf(msg.sender)>=45,"Low degen");
            playerCards[msg.sender].epic +=1;
            burn(30);
        }else if(_card == Cards.mythic){
            require(balanceOf(msg.sender)>=60"Low degen");
            playerCards[msg.sender].mythic +=1;
            burn(40);
        }else if(_card == Cards.legendary){
            require(balanceOf(msg.sender)>=,"Low degen");
